...
| REQ-012 | DONE | `tests/`, `tools/render_pc_gallery.gd`, `scripts/tools/ArtAssetAuditor.gd` | 19-suite strict-log regression、153-slot art audit、720p 奖励页、资源排除与导出包启动验证通过 | none | L3-post | 0 |
